<template>
    <div style = "width:405px">
        ...
        <div class = " flex flex-center" style = "flex-direction:column">
          ...
          <!-- <q-btn flat label="avatar" icon ="launch" style  = "margin:5px" @click="_dialogs({'avatarMenu': {'medium' : true}})"/> -->

          <q-img :src="register.avatar" style="border: 4px solid #222; border-radius:50%; margin-bottom:8px;margin-top:-8px; display:flex" :img-style="{ 'border-radius': '50%','height': '105%'}" width="80px" height="80px">
            <q-tooltip>
                change avatar
            </q-tooltip>
